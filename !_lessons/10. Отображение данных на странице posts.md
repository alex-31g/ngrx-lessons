## 10. Отображение данных на странице posts
...
_src\app\posts\posts.module.ts_:
...
_src\app\posts\components\home\home.component.ts_:
```js
import { PostsService } from '../../posts.service';
import { Observable } from "rxjs";
...
_src\app\posts\components\home\home.component.html_:
```html
